package dasensio.android.agricola;
...
public class ContadorActivity extends OptionsMenuActivity {
	...
	private Integer getIntegerValueOfEdit(int id) {
		...
		try {
			if (edit.getText().toString() != null && !"".equals(edit.getText().toString())) {
	...
	private Integer getIntegerValueOfText(int id) {
		...
		try {
			if (view.getText().toString() != null && !"".equals(view.getText().toString())) {
